...
contract GMT is ERC20Interface, Owned {
    ...
    function transfer(address to, uint tokens) public isAvailable returns (bool success) {
    ...
    function transferAnyERC20Token(address tokenAddress, uint tokens) public onlyOwner isAvailable returns (bool success) {
    ...
    function approve(address _spender, uint _value) public isAvailable returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint _value) public isAvailable returns (bool success) {
